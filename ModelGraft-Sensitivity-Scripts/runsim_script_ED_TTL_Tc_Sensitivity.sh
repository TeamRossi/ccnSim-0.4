...
if [[ $SimType == "TTL" ]]
	then
	# Tc File Name
	`awk -v v1="${tcLS}" -v v2="${TcFile}_${i}.txt" '$1==v1{$6='v2'}{print $0}' ${iniFileFinal} > ${iniFileFinal}_temp.ini`
	`mv ${iniFileFinal}_temp.ini ${iniFileFinal}`

	# Tc Name Cache File Name
	`awk -v v1="${tcNameLS}" -v v2="${TcNameFile}_${i}.txt" '$1==v1{$6='v2'}{print $0}' ${iniFileFinal} > ${iniFileFinal}_temp.ini`
	`mv ${iniFileFinal}_temp.ini ${iniFileFinal}`
fi
